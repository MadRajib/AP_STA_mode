...
int init_spiff1(int, char *, const char *, const char *);
...
esp_err_t post_handler(httpd_req_t *req){
    ...
    esp_err_t ret_1 = esp_vfs_spiffs_register(&conf);
...
int init_spiff1(int mode, char *ssid, const char *psswd, const char *url)
{
    char *TAG = "SPIFF";
    char *data = NULL;
...
void app_main(void)
{
    ...
    ret = init_spiff1(SP_READ, NULL, NULL, NULL);
    if(ret < 0) 
        return;
